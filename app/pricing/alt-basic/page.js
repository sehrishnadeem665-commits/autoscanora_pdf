...
export default function AltBasicPage() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      window.Paddle.Checkout.open({
        ...
        cancelUrl: `${window.location.origin}/pricing/alt-basic?payment=cancelled`,
        settings: {
          theme: 'light',
          displayMode: 'overlay',
        },
            ...
            <div className="bg-gray-50 border border-gray-200 rounded-2xl p-5">
              ...
              <div className="space-y-3 text-sm">
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900 font-medium">Basic Plan</span>
                </div>
                <div className="flex justify-between">
